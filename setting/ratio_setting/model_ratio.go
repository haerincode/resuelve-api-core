...
var defaultModelRatio = map[string]float64{
	...
	// Resuelve-API official catalog (2026) — Chile & LatAm
	"claude-sonnet-5":                           350,  // $0.70 / 1M tokens
	"claude-opus-5":                             875,  // $1.75 / 1M tokens
	"claude-fable-5":                            1250, // $2.50 / 1M tokens
	"gpt-5.6-sol":                               250,  // $0.50 / 1M tokens (overrides existing)
	"gpt-5.6-luna":                              125,  // $0.25 / 1M tokens (overrides existing)
	"gpt-5.6-terra":                             70,   // $0.14 / 1M tokens (overrides existing)
	"grok-4.6":                                  225,  // $0.45 / 1M tokens
	"gemini-3.7-flash":                          20,   // $0.040 / 1M tokens
	"gemini-3.6-flash":                          17.5, // $0.035 / 1M tokens
	"qwen3.8-max":                               210,  // $0.42 / 1M tokens
	"glm-5.3":                                   175,  // $0.35 / 1M tokens
	...
	"gpt-5.6-sol":                               250, // Resuelve-API override: $0.50 / 1M
	"gpt-5.6-terra":                             70,  // Resuelve-API override: $0.14 / 1M
	"gpt-5.6-luna":                              125, // Resuelve-API override: $0.25 / 1M
	"gpt-3.5-turbo":                             0.25,
...
var defaultCompletionRatio = map[string]float64{
	...
	"gpt-image-1":    8,
	"gpt-image-2":    8,
	// Resuelve-API official catalog (2026) — output ratios
	"claude-sonnet-5":  5,
	"claude-opus-5":    5,
	"claude-fable-5":   5,
	"gpt-5.6-sol":      4,
...
var defaultImageRatio = map[string]float64{
	"gpt-image-1": 2,
	"gpt-image-2": 12.5, // $0.025 per image — Resuelve-API catalog
}
