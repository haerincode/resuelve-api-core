...
func UniversalVerify(c *gin.Context) {
	...
	if strings.TrimSpace(request.Code) == "" {
		common.ApiError(c, errors.New("El código de verificación no puede estar vacío"))
		return
	}
	...
	if !validateTwoFactorAuth(twoFA, request.Code) {
		common.ApiError(c, errors.New("Verificación fallida, por favor revise el código"))
		return
	}
