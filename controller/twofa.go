...
func Setup2FA(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": "Autenticación de dos factores configurada correctamente. Escanea el código QR con tu aplicación de autenticación e ingresa el código de verificación para completar la configuración",
...
func Enable2FA(c *gin.Context) {
	...
	if !common.ValidateTOTPCode(twoFA.Secret, cleanCode) {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": "Código de verificación o código de respaldo incorrecto, intenta nuevamente",
		})
		return
	}
